...
const Dashboard = () => {
  ...
  const renderTransactionDateCell = (dateString) => {
    const dateTime = formatTransactionDateTime(dateString);
    return (
      <td className="px-2 sm:px-5 py-3 text-slate-800 dark:text-slate-300 whitespace-nowrap transition-colors">
  ...
  const renderTransactionTimeCell = (dateString) => {
    const dateTime = formatTransactionDateTime(dateString);
    return (
      <td className="px-2 sm:px-5 py-3 text-slate-600 dark:text-slate-400 font-mono text-xs whitespace-nowrap transition-colors">
        {dateTime.time}
      </td>
    );
  };
            ...
            {activeTab === 'payments' ? (
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-100 dark:bg-slate-900/50 text-slate-700 dark:text-slate-500 transition-colors">
                  <tr>
                    <th className="px-2 sm:px-5 py-2 font-semibold text-center">No.</th>
                  ...
                  {tableLoading ? (
                    ...
                    payments.map((payment, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-2 sm:px-5 py-3 text-center text-slate-600 dark:text-slate-400 font-mono text-xs transition-colors">{rowNumber}</td>
                          {renderTransactionDateCell(payment.createdAt)}
                          {renderTransactionTimeCell(payment.createdAt)}
                  ...
                  {tableLoading ? (
                    ...
                    fundTransfers.map((transfer, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-2 sm:px-5 py-3 text-center text-slate-600 dark:text-slate-400 font-mono text-xs transition-colors">{rowNumber}</td>
                          {renderTransactionDateCell(dateTimeValue)}
                          {renderTransactionTimeCell(dateTimeValue)}
                          <td className="px-5 py-3">
              ...
              <table className="w-full text-left text-xs">
                <thead className="bg-slate-100 dark:bg-slate-900/50 text-slate-700 dark:text-slate-500 transition-colors">
                  <tr>
                    ...
                    <th className="px-2 sm:px-5 py-2 font-semibold whitespace-nowrap">Date</th>
                    <th className="px-2 sm:px-5 py-2 font-semibold whitespace-nowrap">Time</th>
                    <th className="px-2 sm:px-5 py-2 font-semibold">Ref1</th>
                  ...
                  {tableLoading ? (
                    ...
                    qrPayments.map((qrPayment, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="px-2 sm:px-5 py-3 text-center text-slate-600 dark:text-slate-400 font-mono text-xs transition-colors">{rowNumber}</td>
                          {renderTransactionDateCell(qrPayment.createdAt)}
                          {renderTransactionTimeCell(qrPayment.createdAt)}
                          <td className="px-5 py-3">
